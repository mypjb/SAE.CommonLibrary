...
namespace SAE.Framework.ObjectMapper.Test.Snippets.TypeConverters
{
    public sealed class YesNoConverterSnippet : MappingBase
    {
        ...
        public void Converter()
        {
            ...
            XAssert.True(target.Yes);
            XAssert.False(target.No);
        }
