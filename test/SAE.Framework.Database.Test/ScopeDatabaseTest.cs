...
using Constants = SAE.Framework.Test.Constants;

namespace SAE.Framework.Database.Test
{
                          ...
                          Enumerable.Range(0, count + 1)
                                    .ForEach(p =>
                                    {
                                        ...
                                        if (max > s && count == p)
                                        {
                                            ...
                                            dict[$"{key}:{nameof(DBConnectOptions.ConnectionString)}"] = $"Data Source={SAE.Framework.Test.Constants.DBConnection.MYSQL.Server};Database={databaseName};User ID={SAE.Framework.Test.Constants.DBConnection.MYSQL.UId};Password={SAE.Framework.Test.Constants.DBConnection.MYSQL.Password};pooling=true;port=3306;sslmode=none;CharSet=utf8;allowPublicKeyRetrieval=true";
                                            ...
                                            dict[$"{key}:{nameof(DBConnectOptions.InitialConnectionString)}"] = $"Data Source={SAE.Framework.Test.Constants.DBConnection.MYSQL.Server};User ID={SAE.Framework.Test.Constants.DBConnection.MYSQL.UId};Password={SAE.Framework.Test.Constants.DBConnection.MYSQL.Password};pooling=true;port=3306;sslmode=none;CharSet=utf8;allowPublicKeyRetrieval=true"; ;
