        ...
        Enumerable.Range(0, this._maxIndex + 1)
                  .ForEach(s =>
                  {
                      ...
                      if (s == this._maxIndex)
                      {
                          ...
                          dict[$"{key}:{nameof(DBConnectOptions.Provider)}"] = SAE.Framework.Constants.Database.Provider.MySQL;
                      ...
                      else
                      {
                          ...
                          dict[$"{key}:{nameof(DBConnectOptions.Provider)}"] = s % 2 == 0 ? SAE.Framework.Constants.Database.Provider.MySQL : SAE.Framework.Constants.Database.Provider.SQLServer;
                      }
