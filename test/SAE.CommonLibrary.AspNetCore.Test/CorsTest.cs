...
namespace SAE.CommonLibrary.AspNetCore.Test
{
    public class CorsTest : HostTest
    {
        ...
        {
            var optionsRequest = new HttpRequestMessage(HttpMethod.Options, "/auth/api/home");
            ...
            var request = new HttpRequestMessage(HttpMethod.Post, "/auth/api/home");
            var responseMessage = await this._client.SendAsync(request);
            var json = await responseMessage.Content.ReadAsStringAsync();
            this.WriteLine(new { cors = json });
