...
namespace SAE.Framework.Database.SQLServer.Responsibility
{
    /// <summary>
    /// 微软<see cref="SAE.Framework.Constants.Database.Provider.SQLServer"/><see cref="DatabaseResponsibility"/>实现
    /// </summary>
    /// <inheritdoc/>
